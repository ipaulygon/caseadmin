 ...
 *
 * @version ViewUser.java
 * @version Created on Sep 16, 2017, 2:47:41 AM
 * @author Andrei
 */

public class ViewUser extends AbstractPageBean {
    @EJB
    ...
    public void init() {
        ...
        try {
            ...
            log("ViewUser Initialization Failure", e);
    ...
    public void prerender() {
        ...
        List<Tbluser> listOfUsers = tbluserFacade.findAll();
        Tbluser[] arrayOfUsers = listOfUsers.toArray(new Tbluser[0]);
        sb1.setUserArray(arrayOfUsers);
    }
