 ...
 * @version Created on Sep 16, 2017, 7:59:17 AM
 * @author Andrei
 */
...
public class EditUser extends AbstractPageBean {
    ...
    public void prerender() {
        ...
        Tbluser user = sb1.getUserDataForEdit();
        this.txtId.setText(user.getId());
        this.txtFirst.setText(user.getFirstName());
        this.txtMiddle.setText(user.getMiddleName());
        this.txtLast.setText(user.getLastName());
    }
    ...
    public String btnRegister_action() {
        ...
        try{
            ...
            Tbluser newUser = sb1.getUserDataForEdit();
            newUser.setFirstName(first);
            newUser.setMiddleName(middle);
            newUser.setLastName(last);
            tbluserFacade.edit(newUser);
            this.info("Successsfully updated record!");
        }catch(Exception e){
            this.info(e+"");
        }
        return null;
