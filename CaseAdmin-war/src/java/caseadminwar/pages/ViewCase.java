 ...
 *
 * @version ViewCase.java
 * @version Created on Sep 16, 2017, 2:37:45 AM
 * @author Andrei
 */

public class ViewCase extends AbstractPageBean {
    @EJB
    ...
    public void init() {
        ...
        try {
            ...
            log("ViewCase Initialization Failure", e);
    ...
    public void prerender() {
        ...
        List<CaseEntries> list_of_case_entries = caseEntriesFacade.findAll();
        CaseEntries[] array_of_cases = list_of_case_entries.toArray(new CaseEntries[0]);
